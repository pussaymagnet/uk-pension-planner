...
React + Vite app for pension contributions, take-home estimates, and household budget. Optional **Supabase** sign-in syncs pension inputs and budget data to the cloud.
